        ...
        html.Div([
            html.Div([
                ...
                dcc.Input(
                        ...
                        debounce=False, value=2, min=1, max=10000000),
                ...
                dcc.Input(
                        ...
                        debounce=False, value=50000, min=50, max=10000000),
                html.Div('ICU capacity:',
                        style={'margin-bottom': 3, 'margin-top': 15,
                            'font-weight': 'bold'}),
                dcc.Input(
                        id="num-icus", type="number",
                        debounce=False, value=10000, min=1, max=1000000),
                html.Div('Ventilators capacity:',
                        style={'margin-bottom': 3, 'margin-top': 15,
                            'font-weight': 'bold'}),
                dcc.Input(
                        id="num-ventilators", type="number",
                        debounce=False, value=1000, min=1, max=500000),
